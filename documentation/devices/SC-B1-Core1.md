...
| --------- | --------------- | ------------ | --------- |
| SPINES | Vlan4094 | 169.254.0.1 | Port-Channel1 |
...
!
interface Ethernet1
   description MLAG_SC-B1-Core2_Ethernet1
   no shutdown
...
interface Port-Channel1
   description MLAG_SC-B1-Core2_Port-Channel1
   no shutdown
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | ROUTER_ID | default | 172.16.0.1/32 |
